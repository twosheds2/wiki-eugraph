...
ggplot(long_data, aes(x = end_date, y = value, color = category)) +
     ...
     scale_x_date(date_labels = "%b %Y",
                    breaks = seq(from = ymd("2020-01-01"), to = ymd("2026-01-01"), by = "6 months"),    # Y axis breaks - update if changing limits below
                    date_minor_breaks = "1 month",
                    limits = c(ymd("2019-12-01"), ymd("2026-03-01")),  # Sets the date range on the X axis
